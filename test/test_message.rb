  ...
  class MessageTest < Minitest::Test
    ...
    def _checkForm(html, message_, action_url,
      ...
      @form_tag_attrs.each do |k, v|
        ...
        message_.to_post_args.each do |name, value|
          success = false
