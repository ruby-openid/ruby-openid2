...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/pboling/ruby-openid2"
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.1", ">= 2.1.1")      # ruby >= 2.7.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.3")             # ruby >= 2.7.0
  ...
  # The 'git' gem is optional; ruby-openid2 falls back to shelling out to `git` if it is not present.
